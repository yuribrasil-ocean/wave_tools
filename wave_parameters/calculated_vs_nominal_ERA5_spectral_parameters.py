...
# LIst of filenames
filename_string_list = ['hs_comparison_ERA5',
                        'tp_comparison_ERA5', 'tm_comparison_ERA5', 
                        'dm_comparison_ERA5']
...
parameter_tick_labels_list = [hs_tick_labels, t_tick_labels, 
                              t_tick_labels, d_tick_labels]
